    ...
    <div class="row" id="splashProductcontainer">
        <div class="col-md-6">
            <div class="splashProduct one">
                ...
                <p><a class="btn btn-warning" href="sst.php" role="button">Maps+Graphs &raquo;</a></p>
            </div>
        </div>
        <div class="col-md-6">
            <div class="splashProduct two">
                ...
                <p><a class="btn btn-warning" href="oceancolour.php" role="button">Maps+Graphs &raquo;</a></p>
            </div>
        </div>
