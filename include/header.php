                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            <li><a class="navbar-brand" href="<? echo $BASEDIR ?>index.php" alt="home page">Home</a>
                            </li>
                            <li><a class="navbar-brand" href="<? echo $BASEDIR ?>news.php" alt="news items">News</a>
                            </li>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"> Contacts<span
                                        class="caret"></span></a>
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="<? echo $BASEDIR ?>acknowl.php"
