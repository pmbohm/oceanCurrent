...
<head>
    ...
    <link rel="icon" href="<? echo $BASEDIR ?>img/IMOSfavicon.ico">

    <title><? echo "IMOS - OceanCurrent ";
        echo $title ?></title>

    <link href="<? echo $BASEDIR ?>css/bootstrap.css" rel="stylesheet">
    <link href="<? echo $BASEDIR ?>css/oceancurrent.css" rel="stylesheet">
...
<body>
    ...
    <div class="jumbotron">
        <div class="container">
            ...
            <header>
                <a class="homelink" href="<? echo $BASEDIR ?>index.php" alt="IMOS Ocean Current home page"
            ...
            <p><a class="btn btn-primary" href="<? echo $BASEDIR ?>news.php" role="button">Latest News &raquo;</a></p>
            ...
            <nav class="navbar navbar-default" role="navigation">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="http://imos.org.au" alt="IMOS home page">IMOS</a></li>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li><a class="navbar-brand" href="<? echo $BASEDIR ?>index.php" alt="home page">Home</a></li>
                            <li><a class="navbar-brand" href="<? echo $BASEDIR ?>news.php" alt="news items">News</a></li>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"> Contacts<span class="caret"></span></a>
                                <ul class="dropdown-menu" role="menu">

                                    <li><a href="<? echo $BASEDIR ?>acknowl.php" alt="Acknowledgements" >Acknowledgements</a></li>
                                    <li><a href="<? echo $BASEDIR ?>glossary.php" alt="Glossary" >Glossary</a></li>
                                    <li class="divider"></li>
