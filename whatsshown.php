...
?>
    ...
    <article>
        <h3>SST High-resolution zoom-ins  <a href="<?= $BASEDIR ?>sst.php" class="btn btn-primary inlineButton" type="button">SST Maps <span
        ...
        <p>
            To view the animations you will need software to play fli-format files, eg Quicktime or Aawin <a
                href=<?= $BASEDIR ?>install.htm>[help]</a>.
        ...
        <p>
            Overlain on the temperature imagery are the <a href=<?= $BASEDIR ?>glossary.htm#GSL>sea level</a> (contours
            ...
            and deep-drifting, surface-profiling Argo floats <a href="<?= $BASEDIR ?>sourcedata/">[FFI]</a>. The arrows
            ...
            many days for the <a href=<?= $BASEDIR ?>glossary.htm#altimeter>altimeters</a> to sample the globe.
        </p>
        ...
        <p>
            ...
            <a href=<?= $BASEDIR ?>misc/Ningaloo2007.AVI> [Ningaloo, 7 Nov 2007 - AVI format]</a>
            <a href=<?= $BASEDIR ?>misc/Syd20070315.fli> [Sydney, 15 March 2007 - fli format]</a>
            <a href=<?= $BASEDIR ?>misc/Syd20070315.AVI> [Sydney, 15 March 2007 - AVI format]</a>
    </article>

    <article>
        <h4>Regional maps - left panel FIX THIS <a href="<?= $BASEDIR ?>sst.php" class="btn btn-primary inlineButton" type="button">SST Maps <span
                    class="badge">GO</span></a></h4>
        <p>The colour-coded field is a map of tidal-residual, <a href=<?= $BASEDIR ?>glossary.htm#isostatic>isostatically-adjusted</a>
            <a href=<?= $BASEDIR ?>glossary.htm#GSLA> sea level anomaly</a>, valid for the analysis date <b>T_a</b>
        ...
        <p>How do we know that the ocean has areas where the water is raised or lowered by half a meter or so, for 100's
            ...
            where satellites carrying <a href=<?= $BASEDIR ?>glossary.htm#altimeter><b>radar altimeters</b></a> have
        ...
        <p>
            ...
            all around the country <a href="<?= $BASEDIR ?>sourcedata/">[FFI]</a>. We include these data in our maps by
        ...
        <p>The right panel shows the sea level map again, but this time as total sea level, ie, the anomaly plus an <a
                href=<?= $BASEDIR ?>glossary.htm#CAST>CAST2008</a> estimate of the mean surface dynamic height with
        ...
        <p>The SST map is best for precisely locating where the ocean currents are, while the sea level map is good for
            ...
            Surface Velocity Program (SVP) drifters <a href="<?= $BASEDIR ?>sourcedata/">[FFI]</a>, which are shown in
    ...
    <article>
        <h4>Large Area Australasian maps <a href="<?= $BASEDIR ?>sst.php" class="btn btn-primary inlineButton" type="button">SST Maps <span
                    class="badge">GO</span></a></h4>
        <p>When you enter this series of maps of the Australasian region, you are first shown a map of the Sea Surface
            Temperature seasonal anomaly. This is the difference of SST (composited over 6 days) from the <a
                href=<?= $BASEDIR ?>glossary.htm#CARS>CARS2009</a> atlas estimate for the time of year. Also shown are
        ...
        <p>[uv] shows the sea level with the <a href=<?= $BASEDIR ?>glossary.htm#CAST>CAST2008</a> estimate of the mean
