...
<dl>
    ...
    <dd>
        ...
        <a href="http://www.eumetsat.int/Home/Main/Satellites/Jason-2/index.htm?l=en" target="blank">EuMetSat
            Jason-2</a> <br>
    ...
    <dd> Advanced Very High Resolution Radiometer. A sensor carried by the <a href=http://www.noaa.gov/>US National
            Ocean and Atmosphere Administration (NOAA)</a> satellites which oceanographers use to measure Sea Surface
        Temperature (SST). The pixel size is about 1km and accuracy about +/-0.6&#176C. The NOAA satellites broadcast
        ...
        archived at <a href=http://www.dola.wa.gov.au/home.nsf/(FrameNames)/Satellite+Images> WASTAC </a> in Perth, <a
            href=http://www.bom.gov.au>Bureau of Meteorology</a> in Melbourne, <a
            href=http://www.marine.csiro.au/~lband/index.html> CSIRO</a> in Hobart and <a
            href=http://www.auslig.gov.au/acres/index.htm> ACRES</a> in Alice Springs.
    ...
    <dd> otherwise known as a topographic Rossby Wave, a Coastal Trapped Wave is a large-scale, sub-inertial wave with
    ...
    <dd> the `pseudo-force' on an object moving with respect to a rotating frame of reference. A cannon shell appears to
    ...
    <dd> The name given to the several-day-old altimetry data product that first made it possible in ~2000 to use
    ...
    <dd> To a fairly good approximation, a local reduction of atmospheric pressure of 10hPa leads to a sea level rise of
    ...
    <dd> When we refer to 'isostatically-adjusted' sea level, we mean we have subtracted the 'inverse barometer'
    ...
    <dd>short for 'synthetic temperature and salinity'. This data product is also described on this website as
        'Satellite adjusted climatology' as explained at <a href=profiles/whatsshown.htm>[what's shown]<a>. The synTS
                ...
                <dd>The principle method for validating our altimetric surface velocity estimates is by comparing them
                    to the velocity of Surface Drifters, or <a href="http://www.aoml.noaa.gov/phod/dac/dacdata.php">Global
                        Lagrangian Drifters</a>. These buoys are tracked by the Argos positioning system (not to be
                ...
                <dd> when water is drawn to the surface from great depth. It is a very significant phenomenon because it
                ...
                <dd> The effect on the ocean of the wind increases greatly as the wind velocity increases. The wind
                    stress is a measure of this effect and is approximately proportional to the square of the wind
                    velocity.
</dl>
